...
class TestRankErrors(unittest.TestCase):
    def test_basic(self):
        ...
        expected = {"Something failed absolutely": {"ERROR": "Something failed absolutely", "OCCURED": 2}, "Little thing broken": {"ERROR": "Little thing broken", "OCCURED": 1}}
    ...
    def test_error_and_info(self):
        ...
        expected = {"Browser failed again": {"ERROR": "Browser failed again", "OCCURED": 2}}
        self.assertEqual(rank_errors(testcase), expected)
    ...
    def test_brackets_in_error(self):
        ...
        expected = {"Something failed (or broken) absolutely": {"ERROR": "Something failed (or broken) absolutely", "OCCURED": 2}, "Little thing broken (asta la vista!)": {"ERROR": "Little thing broken (asta la vista!)", "OCCURED": 1}}
        self.assertEqual(rank_errors(testcase), expected)
...
class TestSortUsersStat(unittest.TestCase):
    def test_basic(self):
        ...
        expected = {"admin": {"USERNAME": "admin", "ERROR":1, "INFO":0}, "debian_root": {"USERNAME": "debian_root", "ERROR":1, "INFO":0}, "info_user": {"USERNAME": "info_user", "ERROR":1, "INFO":2}}
